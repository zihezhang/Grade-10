...
public class Gamee 
{
	...
	public static void main(String a[])
	{
		...
		//You can make an action listener yourself outside of the program and add that if you like
		...
		class TicTacToeGUI implements ActionListener
		{
			...
			public TicTacToeGUI()
			{
				...
				gameFrame.setLayout(new GridLayout(4, 3));
