...
public class GUI 
{
	public static void main(String[] args) 
	{
		...
		//Combo Box (List)s
		String names[] = {"Maggie","Zuige","Sean","Michal","Dina"};
		final JComboBox nameCombo = new JComboBox(names);
		//Button
		JButton button = new JButton("Who's the coolest person?");
	...
	public void playSound() 
	{
	    try 
	    {
	        AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("Creepy_Music_Box.wav").getAbsoluteFile());
